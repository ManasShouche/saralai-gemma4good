...
const DEMO_SCHEME_DATA: Record<string, SchemeData> = {
  igw_pension: {
    ...
    eligibility_reason: "You are widowed, in BPL category, and aged between 40-79. All eligibility criteria are met.",
  ...
  ka_widow_pension: {
    ...
    eligibility_reason: "Karnataka resident widow. Eligible for additional state pension top-up.",
  ...
  pmuy: {
    ...
    eligibility_reason: "Female from BPL family — eligible for free LPG connection, first refill, and stove.",
    docs_have: ["aadhaar", "ration_card", "bank_passbook"],
    docs_need: [],
  ...
  pm_vidya_lakshmi: {
    ...
    eligibility_reason: "Low-interest education loan available for your children's higher education.",
    docs_have: ["aadhaar"],
